package com.daviddevelops.templates.Inventories.API;

import com.daviddevelops.templates.Inventories.API.content.*;
import com.daviddevelops.templates.Inventories.API.opener.*;
...
public class InventoryManager {
    ...
    private final Map<UUID, CustomInventory> inventories;
    ...
    public Optional<CustomInventory> getInventory(Player p) {
        return Optional.ofNullable(this.inventories.get(p.getUniqueId()));
    }

    protected void setInventory(Player p, CustomInventory inv) {
        if (inv == null)
    ...
    class InvListener implements Listener {
        ...
        public void onInventoryClick(InventoryClickEvent e) {
            ...
            if (clickedInventory == p.getOpenInventory().getTopInventory()) {
                ...
                CustomInventory inv = inventories.get(p.getUniqueId());
